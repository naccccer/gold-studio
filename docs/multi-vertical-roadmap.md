...
- 2026-06-27: Admin billing/user operations separation hardened after QA: manual credit changes and custom plans require an explicit Jewelry/Food vertical, package/subscription assignment lists are grouped by vertical, receipts and user credit history show vertical labels, and purchase approval refuses request/package vertical mismatches.
