...
type PageShellProps = { children: ReactNode; maxWidth?: "md" | "lg"; className?: string };
const maxWidthClasses: Record<NonNullable<PageShellProps["maxWidth"]>, string> = { md: "max-w-3xl", lg: "max-w-5xl" };
