...
const outputPresetSpecs: Record<OutputPresetId, OutputPresetSpec> = {
  post: {
    id: "post",
    providerSize: "1:1",
    instruction: "Output format: square product image for catalog and social post use. Keep generous clean space around the product.",
  },
  story: {
    id: "story",
    providerSize: "9:16",
    instruction: "Output format: vertical 9:16 story image. Keep the product fully visible and avoid cropping important details.",
  },
  banner: {
    id: "banner",
    providerSize: "16:9",
    instruction: "Output format: horizontal 16:9 banner image. Keep the product prominent with refined negative space.",
  },
};
